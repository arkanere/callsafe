    ...
    (function () {
        ...
        class CallSafeClient {
            constructor() {
                ...
                this.isMuted = false;
                this.callState = 'idle';
                this.serverUrl = 'https://tunnel.callsafe.tech';
                this.handle = '${handle}';
            }
            ...
            toggleMute() {
                if (this.localStream) {
                    ...
                    if (audioTrack) {
                        ...
                        const muteBtn = document.getElementById('callsafe-modal-1752763223802-mute-btn');
            ...
            updateStatus(message, state) {
                const statusEl = document.getElementById('callsafe-modal-1752763223802-status');
                const iconEl = document.getElementById('callsafe-modal-1752763223802-icon');
            ...
            showCallControls() {
                const controls = document.getElementById('callsafe-modal-1752763223802-call-controls');
        ...
        function initCallSafe() {
            const widget = document.querySelector('#callsafe-widget-1752763223802');
            const modal = document.querySelector('#callsafe-modal-1752763223802');

            if (!widget || !modal) return;

            const button = widget.querySelector('button');
            const muteBtn = document.getElementById('callsafe-modal-1752763223802-mute-btn');
            const endBtn = document.getElementById('callsafe-modal-1752763223802-end-btn');
...
<!-- CallSafe Anonymous Calling Widget -->
<div id="callsafe-widget-1752763223802">
    <button
        type="button"
...
<!-- CallSafe Modal -->
<div
    id="callsafe-modal-1752763223802"
...
>
    <div
        style="background: white; border-radius: 12px; padding: 24px; max-width: 400px; width: 90%; margin: 20px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1);"
    >
        <div style="text-align: center; margin-bottom: 20px;">
            ...
            <p
                id="callsafe-modal-1752763223802-status"
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <div
                style="width: 60px; height: 60px; margin: 0 auto 16px; border-radius: 50%; background: #f3f4f6; display: flex; align-items: center; justify-content: center;"
            >
                <svg
                    id="callsafe-modal-1752763223802-icon"
            ...
            <div id="callsafe-modal-1752763223802-call-controls" style="display: none; margin-top: 16px;">
                <button
                    id="callsafe-modal-1752763223802-mute-btn"
                    type="button"
                ...
                <button
                    id="callsafe-modal-1752763223802-end-btn"
                    type="button"
        ...
        <div style="text-align: center;">
            <button
                type="button"
                onclick="document.getElementById('callsafe-modal-1752763223802').style.display='none'"
